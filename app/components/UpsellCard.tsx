...
// Free-tier upsell shown only on the Dashboard. Not an ad — the real AdMob
// banner lives in <AdBanner /> and is rendered below this card.
export function UpsellCard({ visible, onUpgrade }: Props) {
